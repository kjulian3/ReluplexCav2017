from .ReluplexUtils import *
from . import ReluplexNetwork
import numpy as np

class ReluplexNetworkNNet(ReluplexNetwork.ReluplexNetwork):
    """
    Class that implements a ReluplexNetwork from an NNet file.
    """
    def __init__ (self, filename):
        """
        Constructs a ReluplexNetworkNNet object from an .nnet file.
